define({ "api": [
    ...
    "parameter": {
      ...
      "examples": [
        ...
        },
        {
          ...
          "content": "{\n    https://vtmove-apiv2.ddns.net/api/v1/customer/estimate_fare.php?tripType=Km&distance=10000&SelectedCar=152&totalPointDelivery=2&cod=100000 \n}",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "discount_fare",
            "description": "<p>Khuyến mại giảm giá (của KH)</p>"
          },
          {
            "group": "Success 200",
            "type": "int",
          ...
          },
          {
            ...
            "description": "<p>Tiền thưởng cho Tài xế</p>"
          },
          {
            "group": "Success 200",
            "type": "int",
            "optional": false,
            "field": "raw_fare",
            "description": "<p>Doanh thu của hệ thống (= total_fare - discount_fare)</p>"
          }
        ]
      },
      "examples": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "page",
            "description": "<p>số trang kết quả muốn hiển thị</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
  ...
  },
  {
    ...
    "title": "16. Gửi yêu cầu dịch vụ Car",
    "name": "16__G_i_y_u_c_u_d_ch_v__Car",
    "group": "Customer",
    "description": "<p>Môi trường test: <a href=\"https://vtmove-apiv2.ddns.net\">https://vtmove-apiv2.ddns.net</a></p>",
    "version": "1.0.0",
    "header": {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "rawFare",
            "description": "<p>Tổng cước phí chưa trừ khuyến mãi (cước thô)</p>"
          },
          {
            "group": "Success 200",
            "type": "int",
  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "Body-Example:",
          "content": "{\n    \"fbToken\": EMAWfqVlBdyEsGWpUIFoqH6ZCJZBRPqdCjmt8CUg4yJ06WAqpZCSjqkFZCw2EPOP85cmhlrVSenhsRiNLGfuhsdAMmxmvVaSBdj8iqS1CgMgZDZD\n    \"deviceType\": Android\n    \"deviceToken\": dyEsGWpUIFoqH6ZCJZBRPqdCjmt8CU\n    \"firstName\": An\n    \"LastName\": Mai \n    \"cityId\": 1\n    \"makeId\": 2\n    \"modelId\": 3\n    \"licencePlate\": 29P1 - 57048\n    \"carType\": 159\n}",
          "type": "json"
        }
      ]
    },
